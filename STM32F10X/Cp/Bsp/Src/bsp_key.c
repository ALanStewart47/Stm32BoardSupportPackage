...
#define HARD_KEY_NUM	    3   							/* 实体按键个数（根据自己的项目实际来） */	
...
static const X_GPIO_T s_gpio_list[HARD_KEY_NUM] = {
	{GPIOC, GPIO_PIN_13, 0},		/* K0 -- PC13  , 激活电平为0（低电平）*/
	{GPIOC, GPIO_PIN_14, 0},		/* K1 -- PC14 , 激活电平为0（低电平）*/
	{GPIOC, GPIO_PIN_15, 0}			/* K2 -- PC15 , 激活电平为0（低电平）*/
...
static void bsp_InitKeyVar(void)
{
	...
	bsp_SetKeyParam(KID_K1, 100, 20);
	bsp_SetKeyParam(KID_K2, 80, 2);
	bsp_SetKeyParam(KID_K3, 80, 2);
}
